...
<div class="mb-6">
    <div class="flex items-center space-x-3">
        ...
        <h1 class="text-2xl font-bold text-gray-900">Add New OLT</h1>
    </div>
</div>

<div class="bg-white shadow overflow-hidden sm:rounded-lg border border-gray-100 max-w-3xl">
    <form action="{{ route('olts.store') }}" method="POST" class="p-6">
        @csrf

        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="col-span-2">
                <label for="name" class="block text-sm font-medium text-gray-700">OLT Name (Optional)</label>
                <input type="text" name="name" id="name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-4 py-2 border" value="{{ old('name') }}">
            ...
            <div class="col-span-2 md:col-span-1">
                ...
                <input type="text" name="ip" id="ip" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-4 py-2 border" required>
            ...
            <div class="col-span-2 md:col-span-1">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="telnet_username" id="telnet_username" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-4 py-2 border">
                    ...
                    <div>
                        ...
                        <input type="password" name="telnet_password" id="telnet_password" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-4 py-2 border">
                    ...
                    <div>
                        ...
                        <input type="number" name="telnet_port" id="telnet_port" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-4 py-2 border" value="{{ old('telnet_port', '23162') }}" required>
            ...
            <div class="col-span-2 md:col-span-1">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="snmp_username" id="snmp_username" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-4 py-2 border">
                    ...
                    <div>
                        ...
                        <input type="password" name="snmp_password" id="snmp_password" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-4 py-2 border">
                    ...
                    <div>
                        ...
                        <input type="number" name="snmp_port" id="snmp_port" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-4 py-2 border" value="{{ old('snmp_port', '23161') }}" required>
